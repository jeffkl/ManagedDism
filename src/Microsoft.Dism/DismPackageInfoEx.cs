...
namespace Microsoft.Dism
{
    ...
    public sealed class DismPackageInfoEx : DismPackageInfo, IEquatable<DismPackageInfoEx>
    {
        ...
        /// <returns><see langword="true" /> if the specified <see cref="DismPackageInfoEx" /> is equal to the current <see cref="DismPackageInfoEx" />, otherwise <see langword="false" />.</returns>
