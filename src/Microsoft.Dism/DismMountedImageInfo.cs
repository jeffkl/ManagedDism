...
namespace Microsoft.Dism
{
    ...
    public sealed class DismMountedImageInfo : IEquatable<DismMountedImageInfo>
    {
        ...
        /// <returns><see langword="true" /> if the specified <see cref="DismMountedImageInfo" /> is equal to the current <see cref="DismMountedImageInfo" />, otherwise <see langword="false" />.</returns>
