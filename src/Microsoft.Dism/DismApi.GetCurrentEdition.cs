...
namespace Microsoft.Dism
{
    public partial class DismApi
    {
        ...
        /// <returns>The current edition of the image.</returns>
        ...
        internal static partial class NativeMethods
        {
            ...
            /// <param name="editionId">Recieves a pointer to a string containing the current edition of the image.</param>
            /// <returns>Returns OK on success.</returns>
            [DllImport(DismDllName, EntryPoint = "_DismGetCurrentEdition", CharSet = DismCharacterSet)]
