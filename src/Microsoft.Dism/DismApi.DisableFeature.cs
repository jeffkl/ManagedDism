...
namespace Microsoft.Dism
{
    public static partial class DismApi
    {
        ...
        /// <exception cref="OperationCanceledException">When the operation is canceled.</exception>
        /// <exception cref="DismRebootRequiredException">When the operation requires a reboot to complete.</exception>
        public static Task DisableFeatureAsync(DismSession session, string featureName, string packageName, bool removePayload, IProgress<DismProgress>? progress, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="OperationCanceledException">When the operation is canceled.</exception>
        /// <exception cref="DismRebootRequiredException">When the operation requires a reboot to complete.</exception>
        public static Task DisableFeatureAsync(DismSession session, string featureName, string packageName, bool removePayload, IProgress<DismProgress>? progress, object? userData, CancellationToken cancellationToken = default)
        {
        ...
        internal static partial class NativeMethods
        {
            ...
            /// <remarks><a href="http://msdn.microsoft.com/en-us/library/windows/desktop/hh824766.aspx" /> HRESULT WINAPI DismDisableFeature (_In_ DismSession Session, _In_ PCWSTR FeatureName, _In_opt_ PCWSTR PackageName, _In_ BOOL RemovePayload, _In_opt_ HANDLE CancelEvent, _In_opt_ DISM_PROGRESS_CALLBACK Progress, _In_opt_ PVOID UserData);</remarks>
