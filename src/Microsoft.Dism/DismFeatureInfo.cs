...
namespace Microsoft.Dism
{
    ...
    public sealed class DismFeatureInfo : IEquatable<DismFeatureInfo>
    {
        ...
        /// <returns><see langword="true" /> if the specified <see cref="DismFeatureInfo" /> is equal to the current <see cref="DismFeatureInfo" />, otherwise <see langword="false" />.</returns>
